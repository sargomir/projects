...
$this->title = Module::t('app', 'Update task №{task_id}', ['task_id' => $model->task_id]);
$this->params['breadcrumbs'][] = ['label' => Module::t('app', 'Tasks'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => Module::t('app', 'Task №{task_id}', ['task_id' => $model->task_id]), 'url' => ['view', 'id' => $model->task_id]];
